...
elif [ $TEST_FILE == 'pt-grow-stack' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/pt-grow-stack -a pt-grow-stack --swap-size=4 -- -q  -f run pt-grow-stack < /dev/null
elif [ $TEST_FILE == 'pt-grow-pusha' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/pt-grow-pusha -a pt-grow-pusha --swap-size=4 -- -q  -f run pt-grow-pusha < /dev/null
elif [ $TEST_FILE == 'pt-grow-bad' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/pt-grow-bad -a pt-grow-bad --swap-size=4 -- -q  -f run pt-grow-bad < /dev/null
elif [ $TEST_FILE == 'pt-big-stk-obj' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/pt-big-stk-obj -a pt-big-stk-obj --swap-size=4 -- -q  -f run pt-big-stk-obj < /dev/null
elif [ $TEST_FILE == 'pt-bad-addr' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/pt-bad-addr -a pt-bad-addr --swap-size=4 -- -q  -f run pt-bad-addr < /dev/null
elif [ $TEST_FILE == 'pt-bad-read' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/pt-bad-read -a pt-bad-read -p ../tests/vm/sample.txt -a sample.txt --swap-size=4 -- -q  -f run pt-bad-read < /dev/null
elif [ $TEST_FILE == 'pt-write-code' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/pt-write-code -a pt-write-code --swap-size=4 -- -q  -f run pt-write-code < /dev/null
elif [ $TEST_FILE == 'pt-write-code2' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/pt-write-code2 -a pt-write-code2 -p ../tests/vm/sample.txt -a sample.txt --swap-size=4 -- -q  -f run pt-write-code2 < /dev/null
elif [ $TEST_FILE == 'pt-grow-stk-sc' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/pt-grow-stk-sc -a pt-grow-stk-sc --swap-size=4 -- -q  -f run pt-grow-stk-sc < /dev/null
elif [ $TEST_FILE == 'page-linear' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/page-linear -a page-linear --swap-size=4 -- -q  -f run page-linear < /dev/null
elif [ $TEST_FILE == 'page-parallel' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/page-parallel -a page-parallel -p build/tests/vm/child-linear -a child-linear --swap-size=4 -- -q  -f run page-parallel < /dev/null
elif [ $TEST_FILE == 'page-merge-seq' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/page-merge-seq -a page-merge-seq -p build/tests/vm/child-sort -a child-sort --swap-size=4 -- -q  -f run page-merge-seq < /dev/null
elif [ $TEST_FILE == 'page-merge-par' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/page-merge-par -a page-merge-par -p build/tests/vm/child-sort -a child-sort --swap-size=4 -- -q  -f run page-merge-par < /dev/null
elif [ $TEST_FILE == 'page-merge-stk' ]; then
  pintos --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/page-merge-stk -a page-merge-stk -p build/tests/vm/child-qsort -a child-qsort --swap-size=4 -- -q  -f run page-merge-stk < /dev/null
elif [ $TEST_FILE == 'page-shuffle' ]; then
  pintos --gdb --gdb -v -k -T 5 --qemu  --filesys-size=2 -p build/tests/vm/page-shuffle -a page-shuffle --swap-size=4 -- -q  -f run page-shuffle < /dev/null
else
  echo 'unknown test'
fi
